...
<body>
    ...
    <section class="content-form">
        <form action="{{route('vacancies.store', ['company' => $company->id])}}" method="POST">
            ...
            <span style="color: red;">{{$message}}</span><br><br>
            @enderror
            <label for="">Experiencia Requerida(meses): </label>
            ...
            @enderror
            <label for="">Vacantes disponibles:</label><br>
            ...
            <input type="text" name="applicant_person" placeholder="Encargado" value="{{old('applicant_person')}}"><br>
            ...
            <label for="">Informacion extra: </label><br>
