        ...
        <main class="flex">
            ...
            <form action="{{route('user.auth')}}" method="post">
                ...
                <section class="form-group">
                    <label for="email"><input type="email" id="numero_documento" name="email" placeholder=" correo electronico" value="{{old('email')}}"></label>
                    @error('email')
                    <br>
                ...
                <p>¿No estas registrado?<a href="{{route('users.create')}}"> Registrarse</a></p>
